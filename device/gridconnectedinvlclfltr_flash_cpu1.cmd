...
SECTIONS
{
   ...
   .cinit           : > FLASH_BANK0_SEC1 | FLASH_BANK0_SEC2 | FLASH_BANK0_SEC3,     PAGE = 0, ALIGN(4)
   .init_array      : > FLASH_BANK0_SEC1,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK0_SEC1,     PAGE = 0, ALIGN(4)
   .reset           : > RESET,     PAGE = 0, TYPE = DSECT /* not used, */

   .bss:.cio       : > RAMLS01234,  PAGE = 0
   .stack          : > RAMM1,     	PAGE = 1
   .data           : >> RAMM1 | RAMLS567,        PAGE = 1   //added from COFF to EABI
   .bss            : > RAMLS567,    PAGE = 1
