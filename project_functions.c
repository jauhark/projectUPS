...
//    ADC_setVREF(ADCA_BASE, ADC_REFERENCE_EXTERNAL);
    ...
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER1, ADC_SOC_TRIG, ADC_CHANNEL_IN_Idc,
    ACQPS_SYS_CLKS);
    ...
    ADC_setPPBReferenceOffset(ADCA_BASE, ADC_PPB_NUMBER2, 2048);

    ADC_setPPBTripLimits(ADCA_BASE, ADC_PPB_NUMBER1, 1700, -1700);
